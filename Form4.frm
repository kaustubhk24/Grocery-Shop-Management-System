...
Else
 ...
 strSQL = "INSERT INTO Supplier([sno],[sname],[iname],[quan],[amount]) VALUES('" & Text1.Text & "','" & Text2.Text & "','" & Text3.Text & "','" & Text4.Text & "','" & Text5.Text & "')"
...
ICanDealWithThis:
 MsgBox "Supplier No is Already Present", vbInformation, "GMS"
...
Dim a As String
a = InputBox("Enter Supplier No", "GMS")

If a = "" Then
  MsgBox "Please Enter Supplier No", vbInformation, "GMS"
Else
 ...
 ' Open a Connection object
  ...
  strSQL = "DELETE FROM Supplier WHERE[sno]='" & a & "'"
...
adoConn.ConnectionString = strConn
adoConn.Open
adoRS.Source = "SELECT * FROM Supplier"
adoRS.CursorType = adOpenForwardOnly
adoRS.ActiveConnection = adoConn
adoRS.Open
Do While Not adoRS.EOF
     Text1.Text = adoRS.Fields("sno").Value + 1
     adoRS.MoveNext
Loop
adoRS.close
Set adoRS = Nothing
